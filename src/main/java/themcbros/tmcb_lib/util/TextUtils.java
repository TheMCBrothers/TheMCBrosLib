...
public class TextUtils {
    ...
    public static ITextComponent energy(int amount, EnergyUnit unit) {
        String s1 = String.format(ENERGY_FORMAT, amount);
        return translate("misc", "energy", s1, unit.getName());
    }

    public static ITextComponent energyWithMax(int amount, int max, EnergyUnit unit) {
        String s1 = String.format(ENERGY_FORMAT, amount);
    ...
    public static ITextComponent fluidAmount(int amount) {
        String s1 = String.format(ENERGY_FORMAT, amount);
