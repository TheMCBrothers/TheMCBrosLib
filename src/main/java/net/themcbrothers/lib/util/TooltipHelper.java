...
public final class TooltipHelper {
    ...
    public static void appendAmount(List<Component> tooltip, int amount, int capacity, String unit, ChatFormatting... formatting) {
        ...
        final MutableComponent component = new TextComponent(String.format(format, amount));
     ...
     * @param formatting Optional formatting
     */
    public static void appendRegistryName(List<Component> tooltip, IForgeRegistryEntry<?> entry, ChatFormatting... formatting) {
        if (Minecraft.getInstance().options.advancedItemTooltips) {
            ModHelper.registryNameOf(entry)
